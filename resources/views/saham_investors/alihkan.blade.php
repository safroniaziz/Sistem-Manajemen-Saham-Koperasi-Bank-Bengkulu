    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <form action="{{ route('sahamInvestor.alihkan_post',[$data->id]) }}" method="POST" id="form">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="hidden" name="investor_pembeli" id="investor_pembeli">
                                <select name="investor_pembeli_id" class="form-control selectInvestor" id="investor_pembeli_id" style="width: 100%">
                                </select>
                            </div>
                            <div class="form-group col-md-6">
...
<script>
    ...
    $('#investor_pembeli_id').on('select2:select', function (e) {
        console.log(e.params.data.text);
        $("#investor_pembeli").val(e.params.data.text);
    });
</script>
@endpush
