        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-edit"></i>&nbsp;Edit Data Investor</h3>
                </div>
                <!-- /.box-header -->
                <form action="{{ route('investor.update',[$dataInvestor->id]) }}" method="POST" id="form">
