                            ...
                            <tr>
                                ...
                                <td>
                                    <table>
                                        <tr>
                                            <td>
                                                {{-- <a onclick="editPejabatBerwenang({{ $investor->id }})" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-edit"></i>&nbsp; Edit</a> --}}
                                            </td>
                                            <td>
                                                <form action="{{ route('pejabatBerwenang.delete',[$investor->id]) }}" method="POST" id="form-hapus">
        ...
        function editPejabatBerwenang(id){
            ...
            $.ajax({
                ...
                success : function(data){
                    ...
                    $('#nama_investor_edit').val(data.nama_investor);
