<div class="form-group col-md-6">
    ...
    <input type="text" name="nama_kuasa" id="nm_kuasa"  class="form-control" placeholder="Masukan nama kuasa">
</div>

<div class="form-group col-md-6">
    <label for="">Nomor Identitas: <a style="color:red">(* hanya angka)</a></label>
    <input type="number" name="nomor_identitas_kuasa" id="no_identitas_kuasa"  class="form-control" placeholder="Masukan no identitas">
</div>
