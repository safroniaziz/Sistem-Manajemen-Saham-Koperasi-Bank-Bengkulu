        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-calendar"></i>&nbsp;Tambah Data Institusi</h3>
                </div>
                <!-- /.box-header -->
                <form action="{{ route('institusi.store') }}" method="POST" id="form">
